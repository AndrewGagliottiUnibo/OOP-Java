 ...
 * <p>
 * Implementations must be flexible and consider both upper and lower case
 * strings,
 ...
 * Instead, {@code "J"} should throw an error, as it is ambiguous (January,
 * June, July).
 * Similarly, {@code "Janissary"} should throw an error, as no month with such
 * name.
 * </p>
 */
