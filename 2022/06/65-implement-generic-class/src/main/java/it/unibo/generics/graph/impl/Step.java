...
class Step<N> {
    ...
    /**
     * Creates a further step reaching node {@code currentPosition} following the
     * steps {@code previousSteps}.
     *
    ...
    /**
     * Flattens the step into a path (i.e. a list of nodes), from the initial one to
     * the last one
     * 
