...
//javac -d bin -cp math src/oop/lab02/math/ComplexNum.java
//javac -d bin ./src/oop/lab02/math/ComplexNum.java

//java -cp bin/ oop.lab02.math.ComplexNum -- run code in specific directory
//java -cp ../../../ oop.lab02.math.ComplexNum -- run code from the .class directory
