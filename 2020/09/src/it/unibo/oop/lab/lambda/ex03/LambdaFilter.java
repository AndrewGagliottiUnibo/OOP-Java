...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        LOWER_CASE("to lowercase", String::toLowerCase),
        
        N_CHARS("Count the number of chars", a -> Integer.toString(a.length())),
        
        N_LINES("Count the number of lines", a -> Long.toString(a.chars().filter(e -> e == '\n').count() + 1)),
        
        WORDS("Sort words in alphabetical order", s -> Arrays.stream(s.split(" "))
                .sorted()
